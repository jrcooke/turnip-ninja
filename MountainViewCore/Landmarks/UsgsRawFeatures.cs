...
namespace MountainView.Landmarks
{
    // Data from https://geonames.usgs.gov/domestic/download_data.htm
    ...
    public enum FeatureClass
    {
        ...
        Canal,          // Man-made waterway used by watercraft or for drainage, irrigation, mining, or water power (ditch, lateal).
        ...
        Crater,         // Circular-shaped depression at the summit of a volcanic cone or one on the surface of the land caused by the impact of a meteorite; a man-made depression caused by an explosion (caldera, lua).
        ...
        Levee,          // Natural or man-made embankment flanking a stream (bank, berm).
        ...
        PopulatedPlace, // Place or area with clustered or scattered buildings and a permanent human population (city, settlement, town, village). A populated place is usually not incorporated and by definition has no legal boundaries. However, a populated place may have a corresponding "civil" record, the legal boundaries of which may or may not coincide with the perceived populated place. Distinct from Census and Civil classes.
        PostOffice,     // An official facility of the U.S. Postal Service used for processing and distributing mail and other postal material.
        ...
        Tower,          // A man-made structure, higher than its diameter, generally used for observation, storage, or electronic transmission.
